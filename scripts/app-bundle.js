...
define('au-components/input-currency2',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    "use strict";
    var InputCurrency = (function () {
        function InputCurrency() {
            this.eva = eva_1.Eva.getInstance();
...
define('text!au-components/input-currency2.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"../au-converters/currency-converter\"></require>\n  <input\n    ref=\"inputElement\"\n    type=\"text\"\n    readonly=\"${isReadonly ? 'readonly' : ''}\"\n    disabled=\"${isDisabled ? 'disabled' : ''}\"\n    class=\"${classesString}\"\n    focus.trigger=\"onFocus()\"\n    blur.trigger=\"onBlur()\"\n    keydown.trigger=\"onKeydown($event)\"\n    input.trigger=\"onInput()\"\n    value.one-way=\"currencyAmount | currencyConverter\">\n</template>\n"; });
