...
define('au-components/fae-side',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    "use strict";
    var FaeSide = (function () {
        ...
        FaeSide.prototype.onMoverDialogOpen = function (event) {
            var moverRowList = document.getElementById(this.equationSide + "-mover-row-list");
            this.moverDialogModal.style.display = "block";
        };
        FaeSide.prototype.onMoverDialogDone = function (event) {
            var moverRowList = document.getElementById(this.equationSide + "-mover-row-list");
            for (var i = 0; i < moverRowList.childElementCount; i++) {
                var moverAcctId = moverRowList.children[i].getAttribute("data-acct-id");
        ...
        FaeSide.prototype.onMoverDialogCancel = function (event) {
            this.moverDialogModal.style.display = "none";
            this.bindMoverDialog = false;
        };
        FaeSide.prototype.onMoveRowMouseDown = function (event) {
        ...
        FaeSide.prototype.onMoveRowMouseUp = function (event) {
            var targetRow = event.currentTarget;
        ...
        FaeSide.prototype.onMoveRowMouseLeave = function (event, listItem) {
            if (!this.mouseIsDown) {
                var targetRow = event.currentTarget;
                targetRow.children[0].classList.toggle('aaRowHover', false);
            }
        };
        FaeSide.prototype.onMoveRowMouseEnter = function (event, listItem) {
            if (!this.mouseIsDown) {
                var targetRow = event.currentTarget;
                targetRow.children[0].classList.toggle('aaRowHover', true);
            }
        };
        FaeSide.prototype.onMouseMove = function (event) {
        ...
        FaeSide.prototype.elementY = function (element) {
            return element.getBoundingClientRect().top;
        };
        ;
        FaeSide.prototype.logMouseEvent = function (mouseEvent, selectedMoverRow, targetRow) {
        };
        __decorate([
...
define('au-components/acct-mover',["require", "exports", 'aurelia-framework', '../eva', '../au-components/fae-side'], function (require, exports, aurelia_framework_1, eva_1, fae_side_1) {
    "use strict";
    var AcctMover = (function () {
        function AcctMover(faeSide) {
            this.eva = eva_1.Eva.getInstance();
            this.bindMoverDialog = true;
            this.mouseIsDown = false;
            this.selectedMoverRow = null;
        ...
        AcctMover.prototype.attached = function () {
        };
        AcctMover.prototype.onMoverDialogOpen = function (event) {
            this.bindMoverDialog = true;
            this.moverDialogModal.style.display = "block";
        };
        AcctMover.prototype.onMoverDialogDone = function (event) {
            var moverRowList = document.getElementById(this.equationSide + "-mover-row-list");
            for (var i = 0; i < moverRowList.childElementCount; i++) {
                var moverAcctId = moverRowList.children[i].getAttribute("data-acct-id");
                for (var _i = 0, _a = this.sideAcctList; _i < _a.length; _i++) {
        ...
        AcctMover.prototype.onMoverDialogCancel = function (event) {
            this.moverDialogModal.style.display = "none";
            this.bindMoverDialog = false;
        };
        AcctMover.prototype.onMoveRowMouseDown = function (event) {
            var targetRow = event.currentTarget;
            targetRow.children[0].classList.toggle('aaRowHover', false);
            targetRow.children[0].classList.toggle('aaDragging', true);
            this.mouseIsDown = true;
        ...
        AcctMover.prototype.onMoveRowMouseUp = function (event) {
            var targetRow = event.currentTarget;
            targetRow.children[0].classList.toggle('aaDragging', false);
            targetRow.children[0].classList.toggle('aaRowHover', true);
            this.mouseIsDown = false;
        ...
        AcctMover.prototype.onMoveRowMouseLeave = function (event, listItem) {
            if (!this.mouseIsDown) {
                var targetRow = event.currentTarget;
                targetRow.children[0].classList.toggle('aaRowHover', false);
            }
        };
        AcctMover.prototype.onMoveRowMouseEnter = function (event, listItem) {
            if (!this.mouseIsDown) {
                var targetRow = event.currentTarget;
                targetRow.children[0].classList.toggle('aaRowHover', true);
            }
        };
        AcctMover.prototype.onMouseMove = function (event) {
            if (!this.mouseIsDown || !this.selectedMoverRow) {
                return;
            }
            var mouseY = event.clientY;
        ...
        ;
        AcctMover.prototype.logMouseEvent = function (mouseEvent, selectedMoverRow, targetRow) {
        };
