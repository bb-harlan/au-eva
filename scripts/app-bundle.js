...
define('eva',["require", "exports", './models/bchg', './models/acct-list', './models/acct', './models/tran-list', './models/tran'], function (require, exports, bchg_1, acct_list_1, acct_1, tran_list_1, tran_1) {
    ...
    var Eva = (function () {
        ...
        Eva.prototype.formattedCurrency = function (currency) {
...
define('text!x/x-input.html', ['module'], function(module) { module.exports = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n  <meta charset=\"UTF-8\">\n  <title>Title</title>\n</head>\n<body>\n<p>Hello, experiments.</p>\n<input\n  id=\"myInputText\"\n  type=\"text\"\n  style=\"padding: 5px; text-align: right;\"\n  value=\"Alan\"\n  oninput=\"onInput()\">\n<p id=\"demo\"></p>\n<p id=\"demo2\"></p>\n\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/numeral.js/2.0.6/numeral.min.js\"></script>\n<script>\n  function onInput() {\n    var x = document.getElementById(\"myInputText\").value;\n    document.getElementById(\"demo\").innerHTML = x;\n    document.getElementById(\"demo2\").innerHTML = numeral(-12345678.678).format('0,0.00');\n  }\n</script>\n</body>\n</html>\n"; });
