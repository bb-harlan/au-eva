...
define('au-components/fae-side',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    ...
    var FaeSide = (function () {
        ...
        FaeSide.prototype.attached = function () {
            ...
            var positioningElement = document.getElementById("moverAnchor-" + this.equationSide);
            var moverDialogContent = document.getElementById("moverDialogContent" + this.equationSide);
        ...
        FaeSide.prototype.onMoverOpen = function (event) {
            this.moverNeeded = true;
            this.moverDialog.style.display = "block";
        };
        FaeSide.prototype.onMoverDone = function (event) {
        ...
        FaeSide.prototype.onMoverCancel = function (event) {
            this.moverDialog.style.display = "none";
            this.moverNeeded = false;
        };
        FaeSide.prototype.onMoverMouseDown = function (event) {
        ...
        FaeSide.prototype.onMoverMouseUp = function (event) {
            var targetRow = event.currentTarget;
        ...
        FaeSide.prototype.onMoverMouseLeave = function (event, listItem) {
            if (!this.mouseIsDown) {
                var targetRow = event.currentTarget;
                targetRow.children[0].classList.toggle('aaRowHover', false);
            }
        };
        FaeSide.prototype.onMoverMouseEnter = function (event, listItem) {
            if (!this.mouseIsDown) {
                var targetRow = event.currentTarget;
                targetRow.children[0].classList.toggle('aaRowHover', true);
            }
...
define("au-components/acct-mover", [],function(){});
...
define('au-components/module-tran',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    ...
    var ModuleTran = (function () {
        ...
        ModuleTran.prototype.onMoverOpen = function (event) {
...
define('text!au-components/acct-mover.html', ['module'], function(module) { module.exports = ""; });
