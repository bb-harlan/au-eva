    ...
    var Eva = (function () {
        ...
        Eva.prototype.generateTestData = function () {
            ...
            for (var i = 1; i <= 50; ++i) {
                ...
                var bchg2_1 = new bchg_1.Bchg("B" + this.nextBchgId, randomAcct2, tran, 0, "<change desc: bchg #B" + this.nextBchgId + "; tran #" + tran.id + "; acct #" + randomAcct2.id + "; >", Math.round(Math.random() * 1000000) / 100);
...
define('au-components/input-currency',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    ...
    var InputCurrency = (function () {
        ...
        InputCurrency.prototype.onKeyDown = function () {
        };
        __decorate([
            aurelia_framework_1.bindable, 
            __metadata('design:type', Number)
