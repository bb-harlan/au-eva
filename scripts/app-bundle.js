...
define('au-components/acct-list-fae-mover',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    "use strict";
    var AcctListFaeMover = (function () {
        function AcctListFaeMover() {
            this.eva = eva_1.Eva.getInstance();
        }
