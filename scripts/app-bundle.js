...
define('models/acct',["require", "exports", '../models/acct-bchg-list'], function (require, exports, acct_bchg_list_1) {
    ...
    var EquationSideItem = (function () {
        ...
        EquationSideItem.prototype.isAcct = function () {
            return (this instanceof Acct);
        };
        EquationSideItem.prototype.isAnnotation = function () {
...
define('au-components/fae-side',["require", "exports", 'aurelia-framework', '../eva', '../models/acct-list'], function (require, exports, aurelia_framework_1, eva_1, acct_list_1) {
    "use strict";
    var FaeSide = (function () {
        function FaeSide() {
            this.eva = eva_1.Eva.getInstance();
        }
        FaeSide.prototype.onRowEnter = function (event, listItem) {
            if (listItem) {
        ...
        FaeSide.prototype.onRowLeave = function (event, listItem) {
            if (listItem) {
        ...
        FaeSide.prototype.onRowOpsOpen = function (event, listItem) {
            this.rowOpsBoundingClientRect = event.target.parentElement.getBoundingClientRect();
            this.rowOpsMenuModal.style.display = "block";
        };
        FaeSide.prototype.onRowOpsClose = function (event) {
            this.rowOpsMenuModal.style.display = "none";
        };
        FaeSide.prototype.onGoAcct = function (event, listItem) {
            this.eva.selectedBchg = null;
        ...
        __decorate([
            ...
            __metadata('design:type', acct_list_1.AcctList)
        ], FaeSide.prototype, "acctList", void 0);
        FaeSide = __decorate([
            aurelia_framework_1.customElement('au-fae-side'), 
            __metadata('design:paramtypes', [])
        ], FaeSide);
        return FaeSide;
    }());
    exports.FaeSide = FaeSide;
});
...
define('au-attributes/equation-side',["require", "exports", 'aurelia-framework', '../eva', '../au-components/fae-side'], function (require, exports, aurelia_framework_1, eva_1, fae_side_1) {
    "use strict";
    var EquationSide = (function () {
        function EquationSide(faeSide) {
            this.eva = eva_1.Eva.getInstance();
        ...
        EquationSide.prototype.bind = function () {
            ...
            switch (this.faeSide.equationSide) {
                ...
                case this.eva.SIDE_EQUITIES:
                    ...
                    break;
                default:
                    this.faeSide.acctList = [];
            }
        };
        EquationSide = __decorate([
            aurelia_framework_1.customAttribute('au-equation-side'),
            aurelia_framework_1.inject(fae_side_1.FaeSide), 
            __metadata('design:paramtypes', [fae_side_1.FaeSide])
        ], EquationSide);
        return EquationSide;
    }());
...
define('au-components/acct-mover',["require", "exports", 'aurelia-framework', '../eva', '../models/acct-list'], function (require, exports, aurelia_framework_1, eva_1, acct_list_1) {
    "use strict";
    var AcctMover = (function () {
        function AcctMover() {
            ...
            this.moverDialogModal = null;
        }
        AcctMover.prototype.onDialogOpen = function (event) {
            this.moverAcctList = new acct_list_1.AcctList(this.acctList.equationSide);
            (_a = this.moverAcctList).push.apply(_a, this.acctList);
            var moverDialogPositionProps = this.moverDialogPositionElement.getBoundingClientRect();
        ...
        AcctMover.prototype.onDialogDone = function (event) {
            for (var i = 0; i < this.moverRowList.childElementCount - 1; i++) {
                var listItem = this.moverRowList.children[i].listItem;
        ...
        AcctMover.prototype.onDialogCancel = function (event) {
            this.moverAcctList = null;
            this.moverDialogModal.style.display = "none";
        };
        AcctMover.prototype.onRowMouseDown = function (event) {
        ...
        AcctMover.prototype.onRowMouseUp = function (event) {
            var targetRow = event.currentTarget;
        ...
        AcctMover.prototype.onRowMouseLeave = function (event, listItem) {
            if (!this.mouseIsDown) {
                var targetRow = event.currentTarget;
                targetRow.children[0].classList.toggle('aaRowHover', false);
            }
        };
        AcctMover.prototype.onRowMouseEnter = function (event, listItem) {
            if (!this.mouseIsDown) {
                var targetRow = event.currentTarget;
                targetRow.children[0].classList.toggle('aaRowHover', true);
            }
        };
        AcctMover.prototype.onListMouseMove = function (event) {
            if (!this.mouseIsDown || !this.selectedMoverRow) {
                return;
            }
            var mouseY = event.clientY;
            var moverRowList = event.currentTarget;
            var previousSibling = this.selectedMoverRow.previousElementSibling;
            ...
            var nextSibling = this.selectedMoverRow.nextElementSibling;
        ...
        AcctMover.prototype.onListMouseLeave = function (event) {
            if (this.mouseIsDown && this.selectedMoverRow) {
        ...
        AcctMover.prototype.elementY = function (element) {
        ...
        __decorate([
            aurelia_framework_1.bindable, 
            __metadata('design:type', acct_list_1.AcctList)
        ], AcctMover.prototype, "acctList", void 0);
        __decorate([
            aurelia_framework_1.bindable, 
            __metadata('design:type', Object)
        ], AcctMover.prototype, "moverDialogPositionElement", void 0);
        AcctMover = __decorate([
            aurelia_framework_1.customElement('au-acct-mover'), 
            __metadata('design:paramtypes', [])
        ], AcctMover);
        return AcctMover;
    }());
...
define('au-components/cell-bchg',["require", "exports", 'aurelia-framework', '../eva', '../models/bchg'], function (require, exports, aurelia_framework_1, eva_1, bchg_1) {
    ...
    var CellBchg = (function () {
        ...
        CellBchg = __decorate([
            aurelia_framework_1.customElement('au-cell-bchg'), 
            __metadata('design:paramtypes', [])
        ], CellBchg);
        return CellBchg;
    }());
...
define('au-converters/currency-converter',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
...
define('au-components/input-currency',["require", "exports", 'aurelia-framework', '../au-converters/currency-converter'], function (require, exports, aurelia_framework_1, currency_converter_1) {
    "use strict";
    var InputCurrency = (function () {
        function InputCurrency(element, currencyConverter) {
        ...
        InputCurrency = __decorate([
            ...
            aurelia_framework_1.inject(Element, currency_converter_1.CurrencyConverter), 
            __metadata('design:paramtypes', [Element, currency_converter_1.CurrencyConverter])
        ], InputCurrency);
...
define('au-components/module-acct',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    ...
    var ModuleAcct = (function () {
        ...
        ModuleAcct = __decorate([
            aurelia_framework_1.customElement('au-module-acct'), 
            __metadata('design:paramtypes', [])
        ], ModuleAcct);
        return ModuleAcct;
    }());
...
define('au-components/module-bchg',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    ...
    var ModuleBchg = (function () {
        ...
        ModuleBchg = __decorate([
            aurelia_framework_1.customElement('au-module-bchg'), 
            __metadata('design:paramtypes', [])
        ], ModuleBchg);
        return ModuleBchg;
    }());
...
define('au-components/module-fae',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    ...
    var ModuleFae = (function () {
        ...
        __decorate([
            aurelia_framework_1.bindable, 
            __metadata('design:type', eva_1.Eva)
        ], ModuleFae.prototype, "eva", void 0);
        ModuleFae = __decorate([
            aurelia_framework_1.customElement('au-module-fae'), 
            __metadata('design:paramtypes', [])
        ], ModuleFae);
        return ModuleFae;
    }());
...
define('au-components/module-jrnl',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    ...
    var ModuleJrnl = (function () {
        ...
        ModuleJrnl = __decorate([
            aurelia_framework_1.customElement('au-module-jrnl'), 
            __metadata('design:paramtypes', [])
        ], ModuleJrnl);
        return ModuleJrnl;
    }());
...
define('au-components/module-tran',["require", "exports", 'aurelia-framework', '../eva'], function (require, exports, aurelia_framework_1, eva_1) {
    ...
    var ModuleTran = (function () {
        ...
        ModuleTran.prototype.onMoverDialogOpen = function (event) {
        ...
        ModuleTran = __decorate([
            aurelia_framework_1.customElement('au-module-tran'), 
            __metadata('design:paramtypes', [])
        ], ModuleTran);
        return ModuleTran;
    }());
...
define('au-components/tran-bchg-cells',["require", "exports", 'aurelia-framework', '../eva', './module-tran', '../models/bchg'], function (require, exports, aurelia_framework_1, eva_1, module_tran_1, bchg_1) {
    ...
    var TranBchgCells = (function () {
        ...
        TranBchgCells = __decorate([
            aurelia_framework_1.customElement('au-tran-bchg-cells'),
...
define('au-components/tran-bchg-mover',["require", "exports", 'aurelia-framework', '../eva', '../models/tran-bchg-list'], function (require, exports, aurelia_framework_1, eva_1, tran_bchg_list_1) {
    "use strict";
    var TranBchgMover = (function () {
        function TranBchgMover() {
            this.eva = eva_1.Eva.getInstance();
            this.mouseIsDown = false;
            this.selectedMoverRow = null;
            this.moverDialogModal = null;
        }
        TranBchgMover.prototype.onDialogOpen = function (event) {
            this.moverTranBchgList = new tran_bchg_list_1.TranBchgList();
            (_a = this.moverTranBchgList).push.apply(_a, this.tranBchgList);
            var moverDialogPositionProps = this.moverDialogPositionElement.getBoundingClientRect();
            this.moverDialogPositionTop = moverDialogPositionProps.top;
            this.moverDialogPositionLeft = moverDialogPositionProps.left;
            this.moverDialogModal.style.display = "block";
        ...
        TranBchgMover.prototype.onDialogDone = function (event) {
            for (var i = 0; i < this.moverRowList.childElementCount - 1; i++) {
                var bchg = this.moverRowList.children[i].bchg;
        ...
        TranBchgMover.prototype.onDialogCancel = function (event) {
            this.moverTranBchgList = null;
            this.moverDialogModal.style.display = "none";
        };
        TranBchgMover.prototype.onRowMouseDown = function (event) {
            var targetRow = event.currentTarget;
            targetRow.children[0].classList.toggle('aaRowHover', false);
            targetRow.children[0].classList.toggle('aaDragging', true);
            this.mouseIsDown = true;
        ...
        TranBchgMover.prototype.onRowMouseUp = function (event) {
            var targetRow = event.currentTarget;
            targetRow.children[0].classList.toggle('aaDragging', false);
            targetRow.children[0].classList.toggle('aaRowHover', true);
            this.mouseIsDown = false;
        ...
        TranBchgMover.prototype.onRowMouseLeave = function (event, listItem) {
            if (!this.mouseIsDown) {
                var targetRow = event.currentTarget;
                targetRow.children[0].classList.toggle('aaRowHover', false);
            }
        };
        TranBchgMover.prototype.onRowMouseEnter = function (event, listItem) {
            if (!this.mouseIsDown) {
                var targetRow = event.currentTarget;
                targetRow.children[0].classList.toggle('aaRowHover', true);
            }
        };
        TranBchgMover.prototype.onListMouseMove = function (event) {
            if (!this.mouseIsDown || !this.selectedMoverRow) {
                return;
            }
            var mouseY = event.clientY;
        ...
        TranBchgMover.prototype.onListMouseLeave = function (event) {
            if (this.mouseIsDown && this.selectedMoverRow) {
                this.selectedMoverRow.children[0].classList.toggle('aaDragging', false);
                this.selectedMoverRow.children[0].classList.toggle('aaRowHover', false);
                this.mouseIsDown = false;
        ...
        TranBchgMover.prototype.elementY = function (element) {
            return element.getBoundingClientRect().top;
        };
        ;
        __decorate([
            aurelia_framework_1.bindable, 
            __metadata('design:type', tran_bchg_list_1.TranBchgList)
        ], TranBchgMover.prototype, "tranBchgList", void 0);
        __decorate([
            aurelia_framework_1.bindable, 
            __metadata('design:type', Object)
        ], TranBchgMover.prototype, "moverDialogPositionElement", void 0);
        TranBchgMover = __decorate([
            aurelia_framework_1.customElement('au-tran-bchg-mover'), 
            __metadata('design:paramtypes', [])
        ], TranBchgMover);
        return TranBchgMover;
    }());
    exports.TranBchgMover = TranBchgMover;
});
...
define('au-components/tran-bchg-row-data',["require", "exports", 'aurelia-framework', '../eva', '../models/bchg'], function (require, exports, aurelia_framework_1, eva_1, bchg_1) {
    ...
    var TranBchg = (function () {
        ...
        TranBchg = __decorate([
            aurelia_framework_1.customElement('au-tran-bchg-row-data'), 
            __metadata('design:paramtypes', [])
        ], TranBchg);
        return TranBchg;
    }());
...
define('au-converters/equation-side-converter',["require", "exports", "aurelia-framework", "../eva"], function (require, exports, aurelia_framework_1, eva_1) {
    "use strict";
    var EquationSideConverter = (function () {
        function EquationSideConverter() {
            this.eva = eva_1.Eva.getInstance();
        }
        EquationSideConverter.prototype.toView = function (equationSide, capitalize, plural) {
        ...
        EquationSideConverter = __decorate([
            aurelia_framework_1.valueConverter("equationSideConverter"), 
            __metadata('design:paramtypes', [])
        ], EquationSideConverter);
        return EquationSideConverter;
    }());
    exports.EquationSideConverter = EquationSideConverter;
});
...
define('text!au-components/tran-bchg-mover.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"../au-views/vertical-gridline.html\"></require>\n  <require from=\"../au-views/vertical-gridline-spacer.html\"></require>\n  <require from=\"../au-converters/currency-converter\"></require>\n  <require from=\"../au-converters/equation-side-converter\"></require>\n  <require from=\"../au-components/tran-bchg-row-data\"></require>\n  <require from=\"../au-views/tran-bchg-cells-spacer.html\"></require>\n\n\n  <span click.trigger=\"onDialogOpen($event)\" class=\"aaBtn\"><i class=\"fa fa-arrows-v fa-fw aaIconBlue\"\n                                                              aria-hidden=\"true\"></i> Move rows</span>\n\n  <div element.ref=\"moverDialogModal\" class=\"aaModal\">\n    <div\n      class=\"aaGridContainer aaInlineBlock aaPanelBoxShadow\"\n      css=\"position: absolute;\n           margin-top: 0;\n           margin-left: 1pc;\n           top: ${moverDialogPositionTop}px;\n           left: ${moverDialogPositionLeft}px;\">\n      <div class=\"aaGridTitleBar\" style=\"font-size: larger;\">Move rows</div>\n      <div class=\"aaPanelToolBar\">\n        <div style=\"text-align: center;\">\n          <span click.trigger=\"onDialogDone($event)\" class=\"aaBtn\">Done</span>\n          <span click.trigger=\"onDialogCancel($event)\" class=\"aaBtn\" style=\"margin-left: 4pc;\">Cancel</span>\n          <br>\n          <span class=\"aaFontLabel\">&mdash; Drag & drop row(s) to desired list position(s). &mdash;</span>\n        </div>\n      </div>\n      <div element.ref=\"moverRowList\"\n           class=\"aaGridScrollableRows\"\n           mousemove.trigger=\"onListMouseMove($event)\"\n           mouseleave.trigger=\"onListMouseLeave($event)\">\n        <template repeat.for=\"bchg of moverTranBchgList\">\n          <div\n            class=\"aaRow\"\n            bchg.bind=\"bchg\"\n            mouseenter.trigger=\"onRowMouseEnter($event, listItem)\"\n            mouseleave.trigger=\"onRowMouseLeave($event, listItem)\"\n            mousedown.trigger=\"onRowMouseDown($event)\"\n            mouseup.trigger=\"onRowMouseUp($event)\">\n            <div class=\"aaRowDataCells\">\n              <au-tran-bchg-row-data bchg.bind=\"bchg\"></au-tran-bchg-row-data>\n              <vertical-gridline></vertical-gridline>\n            </div>\n          </div>\n        </template>\n        <!-- End of list row -->\n        <div class=\"aaRow\"  id=\"${eva.END_OF_LIST}\">\n          <div class=\"aaInlineBlock\">\n            <div class=\"aaInlineBlock aaCellText aaFontData\" style=\"position: absolute;\"><span\n              class=\"aaSansSerif aaCellTextEOL\">${eva.END_OF_LIST}</span></div>\n            <tran-bchg-cells-spacer></tran-bchg-cells-spacer>\n            <vertical-gridline-spacer></vertical-gridline-spacer>\n            <tran-bchg-cells-spacer></tran-bchg-cells-spacer>\n            <vertical-gridline></vertical-gridline>\n          </div>\n        </div>\n\n      </div>\n      <div class=\"aaGridFooterBar\"></div>\n    </div>\n<!--\n    <div\n      element.ref=\"moverDialogContent\"\n      class=\"aaPanelContainer aaPanel aaPanelBoxShadow\"\n      css=\"position: absolute;\n           top: ${moverDialogPositionElement.offsetTop}px;\n           left: ${moverDialogPositionElement.offsetLeft}px;\">\n      <div class=\"aaPanelHeader aaPanelHeaderModule\">Row mover</div>\n      <div class=\"aaPanelBody\">\n        <div class=\"aaGridContainer aaInlineBlock\">\n          <div class=\"aaGridTitleBar\" style=\"font-size: larger;\">Account balance changes</div>\n          <div class=\"aaPanelToolBar\">\n            <div style=\"text-align: center;\">\n              <span class=\"aaFontLabel\">Drag & drop any row to desired list position.</span>\n            </div>\n          </div>\n          <div element.ref=\"moverRowList\"\n               class=\"aaGridScrollableRows\"\n               mousemove.trigger=\"onListMouseMove($event)\"\n               mouseleave.trigger=\"onListMouseLeave($event)\">\n            <template repeat.for=\"bchg of moverTranBchgList\">\n              <div\n                class=\"aaRow\"\n                bchg.bind=\"bchg\"\n                mouseenter.trigger=\"onRowMouseEnter($event, listItem)\"\n                mouseleave.trigger=\"onRowMouseLeave($event, listItem)\"\n                mousedown.trigger=\"onRowMouseDown($event)\"\n                mouseup.trigger=\"onRowMouseUp($event)\">\n                <div class=\"aaRowDataCells\">\n                  <au-tran-bchg-row-data bchg.bind=\"bchg\"></au-tran-bchg-row-data>\n                  <vertical-gridline></vertical-gridline>\n                </div>\n              </div>\n            </template>\n          </div>\n          <div class=\"aaGridFooterBar\"></div>\n        </div>\n      </div>\n      <div class=\"aaPanelToolBar\">\n        <div style=\"text-align: center;\">\n          <span click.trigger=\"onDialogDone($event)\" class=\"aaBtn\">Done</span>\n          <span click.trigger=\"onDialogCancel($event)\" class=\"aaBtn\" style=\"margin-left: 4pc;\">Cancel</span>\n        </div>\n      </div>\n    </div>\n-->\n  </div>\n</template>\n"; });
